		...
		<div class="col-md-12">
			...
			<div class="panel panel-default">
				<div class="panel-heading" style="text-align: center;">
					<h1 style="font-weight: bold; color: #335566;">Punjab PDS Route Optimization</h1>
	...
	function handleDistrictCheckboxChange() {
		...
		if (checkbox.checked) {
			...
			if (district_names["District_Name_All"].length > 0) {
				...
				document.getElementById("resultdistrict").innerHTML = "Intra scenario is not feasible in these district " + concatenatedNames;
	...
	if (checkbox.checked) {
		...
		fetch(pythonUrl + 'getGraphData', {
			...
			.then(data => {
				...
				document.getElementById("totalFciDemand").innerHTML = "<span style='color: white; font-size: 14px;'>" + "Total Demand: " + totalDemand + "</span>";
				document.getElementById("totalFciSupply").innerHTML = "<span style='color: white; font-size: 14px;'>" + "Total Supply: " + totalCapacity + "</span>";
